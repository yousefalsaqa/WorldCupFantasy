...
// In production a missing JWT_SECRET must be a hard failure: silently
// falling back to a string that lives in the public repo would let anyone
// forge a signed admin token.
